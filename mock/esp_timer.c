...
{
    time = 0;
    memset((void *)&esp_timer_create_call_value, 0, sizeof(esp_timer_create_call_value_t));
    memset((void *)&esp_timer_start_periodic_value, 0, sizeof(esp_timer_start_periodic_value_t));
}
